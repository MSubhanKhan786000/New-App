    ...
    <footer className="bg-bg text-center text-white">
      <div className="container px-6 pt-6 mx-auto">
        ...
        <div className="grid md:grid-cols-2 md:grid-cols-3">
          <div className="mb-3">
          <h5 className="mb-2.5 text-lg text-left ml-8">
            ...
            <ul className="mb-0 list-none text-left ">
              <li>
                <a className="text-sm text-gray-500 text-left">About Us</a>
              </li>
              <li>
                <a className="text-sm text-gray-500">Contact Us</a>
              </li>
              <li>
                <a className="text-sm text-gray-500">Privacy Policy</a>
              </li>
              <li>
                <a className="text-sm text-gray-500">Terms & Conditions</a>
              </li>
              <li>
      ...
      <div className="bg-footer mb-2 flex flex-col items-center w-full space-y-4">
