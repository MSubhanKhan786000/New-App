...
export default function Filter({ onFilterChange }) {
  ...
  return (
    <Box sx={{ display: 'flex', justifyContent: 'center', mb: 4 }}> {/* Center the filter and add margin-bottom */}
      <Autocomplete
        sx={{
          ...
          '& .MuiAutocomplete-inputRoot': {
            ...
            padding: '8px 14px', // Padding for input field
          },
        }}
        open={open}
        onOpen={handleOpen}
          ...
          <TextField
            ...
            InputProps={{
              ...
              endAdornment: (
                <React.Fragment>
                  {loading ? (
                    <CircularProgress color="primary" size={24} sx={{ mr: 2 }} /> // Larger loader size with margin
                  ) : null}
